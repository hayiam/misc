...
exe "hi! TabLine"         .s:fg_yellow      .s:bg_none        .s:fmt_none
exe "hi! TabLineSel"      .s:fg_yellow      .s:bg_none        .s:fmt_undr
exe "hi! TabLineFill"     .s:fg_yellow      .s:bg_none        .s:fmt_none
...
"NvimTree
exe "hi! NvimTreeFileIcon"      .s:fg_yellow        .s:none  .s:fmt_none
exe "hi! NvimTreeFolderIcon"    .s:fg_green         .s:none  .s:fmt_none
exe "hi! NvimTreeModifiedFile"  .s:fg_orange        .s:none  .s:fmt_none
exe "hi! NvimTreeIndentMarker"  .s:fg_aqua          .s:none  .s:fmt_none

"IndentBlankLine
exe "hi! IndentBlankLineContextChar"   .s:fg_addbg           .s:none  .s:fmt_none

"Diagnostics
exe "hi! DiagnosticLineNrError"  .s:fg_red           .s:none  .s:fmt_none
exe "hi! DiagnosticLineNrWarn"   .s:fg_foreground    .s:none  .s:fmt_none
exe "hi! DiagnosticLineNrInfo"   .s:fg_yellow        .s:none  .s:fmt_none
exe "hi! DiagnosticLineNrHint"   .s:fg_green         .s:none  .s:fmt_none
exe "hi! DiagnosticVirtualTextError"  .s:fg_red                  .s:none  .s:fmt_none
exe "hi! DiagnosticVirtualTextWarn"   .s:fg_foreground           .s:none  .s:fmt_none
exe "hi! DiagnosticVirtualTextInfo"   .s:fg_yellow               .s:none  .s:fmt_none
exe "hi! DiagnosticVirtualTextHint"   .s:fg_green                .s:none  .s:fmt_none
exe "hi! DiagnosticFloatingError"  .s:fg_red                  .s:none  .s:fmt_none
exe "hi! DiagnosticFloatingWarn"   .s:fg_foreground           .s:none  .s:fmt_none
exe "hi! DiagnosticFloatingInfo"   .s:fg_yellow               .s:none  .s:fmt_none
exe "hi! DiagnosticFloatingHint"   .s:fg_green                .s:none  .s:fmt_none
exe "hi! DiagnosticError"  .s:fg_red                  .s:none  .s:fmt_none
exe "hi! DiagnosticWarn"   .s:fg_foreground           .s:none  .s:fmt_none
exe "hi! DiagnosticInfo"   .s:fg_yellow               .s:none  .s:fmt_none
exe "hi! DiagnosticHint"   .s:fg_green                .s:none  .s:fmt_none
...
" misc
exe "hi! SpecialKey"      .s:fg_green       .s:bg_none        .s:fmt_none
...
" fold
exe "hi! Folded"          .s:fg_orange      .s:bg_none  .s:fmt_none
