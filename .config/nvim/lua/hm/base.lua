...
o.keymap="russian-jcukenwin" --setting up ru mode; ctrl+l in insert mode to change keyboard layout
o.iminsert=0
o.imsearch=0
...
o.termguicolors=false --set nvim to use gui colors in terminal, could fix or breake some themes
