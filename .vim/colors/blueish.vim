...
let s:purple = { "cterm": 147, "gui": "#afafff" }
let s:light_green = { "cterm": 154, "gui": "#afff00" }
let s:light_blue = { "cterm": 81, "gui": "#62D8F1" }
let s:magenta = { "cterm": 73, "gui": "#5fafaf" }
let s:orange = { "cterm": 208, "gui": "#FF9700" }
let s:blueish = { "cterm": 195, "gui": "#d7ffff" }
...
call Highlight("Identifier", s:blueish, s:none, s:none)
